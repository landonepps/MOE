...
Message::Message(int id) : HUDelement(id)
{
    xPosition = 0;
    yPosition = 0;
    precision = 0;
...
/***********************************************************************
* setup:   Sets up the Message HUD type using developer specified variables
*
* fontfile: the name of the .ttf file
* R: red value
* G: green value
* B: blue value
* xPos: x coordinate of where to place the Message
* yPos: y coordinate of where to place the Message
* fontSize: size of the font
* precision: precision of Message desired by user.
* id: an id for this HUD type if desired.
*
* returns:   void.
***********************************************************************/
void Message::setup(const string &fontFile, const GLubyte& R, const GLubyte& G, const GLubyte& B,
...
/***********************************************************************
* draw:   Simply draws the Message to the screen
*
* returns:   void.
***********************************************************************/
void Message::draw(){
    ...
    SDL_Surface *surf = TTF_RenderText_Blended(font, value.c_str(), color);
    if (surf == NULL){
        TTF_CloseFont(font);
        return;
    }
